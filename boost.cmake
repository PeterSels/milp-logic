...
ELSEIF(WIN32)
 ...
 set(BOOST_TIMER_LIB libboost_timer-vc90-mt-sgd-${BOOST_VERSION})
 set(BOOST_CHRONO_LIB libboost_chrono-vc90-mt-sgd-${BOOST_VERSION})
 set(BOOST_REGEX_LIB libboost_regex-vc90-mt-sgd-${BOOST_VERSION})
 set(BOOST_SYSTEM_LIB libboost_system-vc90-mt-sgd-${BOOST_VERSION})
ELSE()
 set(BOOST_ROOT /usr/local/boost_${BOOST_VERSION}_0)
ENDIF()
