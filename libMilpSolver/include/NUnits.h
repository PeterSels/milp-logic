...
#define SMALLEST_UNIT_IN_SECONDS (6)

#define N_SMALLEST_UNITS_PER_MIN (60 / SMALLEST_UNIT_IN_SECONDS)
#define UU_PER_MIN (N_SMALLEST_UNITS_PER_MIN)
...
/* eg:
  SMALLEST_UNIT_IN_SECONDS  UU_PER_MIN=UU  UU_PER_HR  INT_VAR_LO  INT_VAR_HI
             60                   1            60          0         1439
             30                   2           120          0         2879
             20                   3           180          0         4319
             15                   4           240          0         5759
